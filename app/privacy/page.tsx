...
export default function PrivacyPage() {
  return <main className="policy-page section-shell">
    ...
    <p>We use Sequenzy to manage our contact list and deliver requested plans. Vercel Analytics and Speed Insights are rendered on this site to understand site activity and performance. PostHog analytics are optional and start only if you choose to allow them. We do not send your email address to analytics providers. Session replay, when active, is configured to mask the listing-plan inputs and free-text fields automatically.</p>

...
export default function TermsPage() {
  return <main className="policy-page section-shell">
    <a className="wordmark" href="/">CINEMA ESTATE<span>™</span></a>
    ...
    <p>We deliver your package within 24 hours of receiving your approved photos and the listing details required to build it. That clock starts when we have everything we need, not when you first place the order — if a required file or fact is missing, we will tell you what's outstanding before the 24 hours starts.</p>
    ...
    <p>You confirm that you own the listing photos you submit or have the rights holder's permission to use them this way. You remain responsible for complying with your MLS's rules, your brokerage's policies, Fair Housing advertising requirements, and any required AI-use disclosure in your market. Cinema Estate discloses that AI-assisted production is used in every package; you are responsible for how you present and distribute the finished assets.</p>
    ...
    <p>Cinema Estate's liability for any claim related to a package is limited to the amount you paid for that package. We are not liable for indirect, incidental, or consequential damages, including lost sales or lost listing opportunities.</p>
